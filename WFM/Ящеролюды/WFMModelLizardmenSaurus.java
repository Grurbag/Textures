...
public class WFMModelLizardmenSaurus extends ModelBase {
	...
	public WFMModelLizardmenSaurus() {
		...
		head.setRotationPoint(1.0F, -26.6F, -5.0F);
		...
		jaw_bot.cubeList.add(new ModelBox(jaw_bot, 50, 46, 0.0F, -5.7F, -5.4F, 6, 2, 8, 0.0F, false));

		teeth_bot = new ModelRenderer(this);
		teeth_bot.setRotationPoint(0.0F, -1.0F, 0.0F);
		jaw_bot.addChild(teeth_bot);
		teeth_bot.cubeList.add(new ModelBox(teeth_bot, 75, 54, 0.0F, -5.7F, -5.4F, 6, 1, 8, 0.0F, false));

		neck = new ModelRenderer(this);
		neck.setRotationPoint(-4.5F, 4.0F, -6.0F);
		head.addChild(neck);
		...
		jaw_top.cubeList.add(new ModelBox(jaw_top, 50, 25, -5.0F, -3.7F, -18.6F, 8, 7, 10, 0.0F, false));

		greben = new ModelRenderer(this);
		greben.setRotationPoint(-0.3956F, -5.59F, -10.9972F);
		head.addChild(greben);
		setRotationAngle(greben, -1.1538F, -0.7325F, -0.2836F);
		greben.cubeList.add(new ModelBox(greben, 1, 64, -11.0F, -12.0F, 0.0F, 23, 23, 0, 0.0F, false));
		...
		tail.cubeList.add(new ModelBox(tail, 220, 0, -3.5F, -4.9948F, 1.2826F, 6, 9, 8, 0.0F, false));

		tail1 = new ModelRenderer(this);
		tail1.setRotationPoint(0.0F, -2.4948F, -1.9174F);
		tail.addChild(tail1);
		setRotationAngle(tail1, -0.0911F, 0.0F, 0.0F);
		tail1.cubeList.add(new ModelBox(tail1, 218, 20, -3.0F, -2.5F, 11.0F, 5, 7, 14, 0.0F, false));

		tail2 = new ModelRenderer(this);
		tail2.setRotationPoint(0.1F, -2.8948F, -1.9174F);
		tail.addChild(tail2);
		setRotationAngle(tail2, -0.182F, 0.0F, 0.0F);
		tail2.cubeList.add(new ModelBox(tail2, 216, 42, -2.0F, -2.0F, 24.0F, 2, 4, 18, 0.0F, false));
		...
		dick_cape.cubeList.add(new ModelBox(dick_cape, 0, 88, -6.5F, -11.5F, 0.0F, 13, 19, 0, 0.0F, false));
