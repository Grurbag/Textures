...
public class WFMModelWitchHunterLegs extends EntityModel<Entity> {
	...
	public WFMModelWitchHunterLegs() {
		texWidth = 64;
		texHeight = 64;
		...
		RightLeg_r1.texOffs(1, 31).addBox(-3.0F, 1.0F, -2.0F, 5.0F, 12.0F, 4.0F, 0.7F, false);
		...
		setRotationAngle(RightLeg_r3, 0.2618F, 0.0F, -0.0436F);
		RightLeg_r3.texOffs(1, 31).addBox(-2.0F, 1.0F, -2.0F, 5.0F, 12.0F, 4.0F, 0.7F, true);
		...
		RightLeg_r4.texOffs(0, 0).addBox(-2.0F, 1.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.7F, true);
	}
