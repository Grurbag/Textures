...
public class WFMModelWarriorPriestBoots extends EntityModel<Entity> {
	private final ModelRenderer RightBoot;
	private final ModelRenderer RightLeg_r1;
	private final ModelRenderer LeftBoot;
	private final ModelRenderer RightLeg_r2;

	public WFMModelWarriorPriestBoots() {
		texWidth = 64;
		texHeight = 64;
		...
		RightLeg_r1.texOffs(2, 32).addBox(-0.5F, 0.0F, -1.35F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		...
		RightLeg_r2.texOffs(2, 32).addBox(-0.5F, 0.0F, -1.35F, 1.0F, 1.0F, 1.0F, 0.0F, true);
