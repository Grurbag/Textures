...
public class WFMModelEmpireGreatswordLeggings extends EntityModel<Entity> {
	...
	public WFMModelEmpireGreatswordLeggings() {
		texWidth = 64;
		texHeight = 64;
		...
		pantalon_r1.setPos(0.2F, 6.5F, 0.0F);
		LeftLeg.addChild(pantalon_r1);
		setRotationAngle(pantalon_r1, -0.0094F, 0.0426F, -0.2184F);
		pantalon_r1.texOffs(16, 0).addBox(-3.0F, -1.5F, -3.0F, 6.0F, 3.0F, 6.0F, 0.1F, false);
		...
		pantalon_r2.setPos(-1.0F, 6.5F, 0.0F);
		RightLeg.addChild(pantalon_r2);
		setRotationAngle(pantalon_r2, 0.0F, 0.0F, 0.2182F);
		pantalon_r2.texOffs(16, 0).addBox(-3.0F, -1.5F, -3.0F, 6.0F, 3.0F, 6.0F, 0.1F, false);
