...
public class WFMModelReiksguardHelmet extends EntityModel<Entity> {
	...
	public WFMModelReiksguardHelmet() {
		...
		Head_r2.texOffs(0, 34).addBox(-4.0F, -4.1F, -4.0F, 8.0F, 9.0F, 8.0F, -0.1F, false);
		Head_r2.texOffs(32, 16).addBox(-4.0F, -4.1F, -4.0F, 8.0F, 9.0F, 8.0F, 0.0F, false);

		venok = new ModelRenderer(this);
		venok.setPos(0.0F, -9.0F, 0.0F);
		Head.addChild(venok);
		setRotationAngle(venok, -0.2449F, 0.4677F, -0.1122F);
		venok.texOffs(50, 38).addBox(4.548F, -3.0F, -3.153F, 0.0F, 3.0F, 7.0F, 0.0F, false);
		venok.texOffs(36, 38).addBox(4.3F, -3.0F, -3.153F, 0.0F, 3.0F, 7.0F, 0.0F, false);

		venok_r1 = new ModelRenderer(this);
		venok_r1.setPos(-5.7057F, 0.0F, -0.9344F);
		venok.addChild(venok_r1);
		setRotationAngle(venok_r1, 0.0F, 2.2253F, 0.0F);
		venok_r1.texOffs(36, 38).addBox(-0.3943F, -3.0F, 0.0F, 0.0F, 3.0F, 7.0F, 0.0F, false);
		venok_r1.texOffs(50, 38).addBox(0.0F, -3.0F, 0.0F, 0.0F, 3.0F, 7.0F, 0.0F, false);

		venok_r2 = new ModelRenderer(this);
		venok_r2.setPos(-2.9695F, 0.0F, 6.5832F);
		venok.addChild(venok_r2);
		setRotationAngle(venok_r2, 0.0F, -2.7925F, 0.0F);
		venok_r2.texOffs(32, 40).addBox(-0.3305F, -3.0F, 0.0F, 0.0F, 3.0F, 8.0F, 0.0F, false);
		venok_r2.texOffs(48, 40).addBox(0.0F, -3.0F, 0.0F, 0.0F, 3.0F, 8.0F, 0.0F, false);

		venok_r3 = new ModelRenderer(this);
		venok_r3.setPos(4.548F, 0.0F, 3.847F);
		venok.addChild(venok_r3);
		setRotationAngle(venok_r3, 0.0F, -1.2217F, 0.0F);
		venok_r3.texOffs(32, 40).addBox(-0.248F, -3.0F, 0.0F, 0.0F, 3.0F, 8.0F, 0.0F, false);
		venok_r3.texOffs(48, 40).addBox(0.0F, -3.0F, 0.0F, 0.0F, 3.0F, 8.0F, 0.0F, false);

		lenta = new ModelRenderer(this);
		lenta.setPos(2.0F, -7.0F, 5.0F);
		Head.addChild(lenta);
		setRotationAngle(lenta, -0.8262F, -1.1597F, -0.9431F);
		lenta.texOffs(0, 42).addBox(0.0F, -1.0F, 0.0F, 0.0F, 1.0F, 9.0F, 0.0F, false);

		lenta_r1 = new ModelRenderer(this);
		lenta_r1.setPos(0.0F, 0.0F, 9.0F);
		lenta.addChild(lenta_r1);
		setRotationAngle(lenta_r1, 0.0F, 0.5672F, 0.0F);
		lenta_r1.texOffs(3, 46).addBox(0.0F, -1.0F, 0.0F, 0.0F, 1.0F, 6.0F, 0.0F, false);

		lenta2 = new ModelRenderer(this);
		lenta2.setPos(-1.0F, -7.0F, 5.0F);
		Head.addChild(lenta2);
		setRotationAngle(lenta2, 0.4492F, -1.1758F, -1.9835F);
		lenta2.texOffs(0, 42).addBox(0.0F, -1.0F, 0.0F, 0.0F, 1.0F, 9.0F, 0.0F, false);

		lenta2_r1 = new ModelRenderer(this);
		lenta2_r1.setPos(0.0F, 0.0F, 9.0F);
		lenta2.addChild(lenta2_r1);
		setRotationAngle(lenta2_r1, 0.0F, 0.5672F, 0.0F);
		lenta2_r1.texOffs(3, 46).addBox(0.0F, -1.0F, 0.0F, 0.0F, 1.0F, 6.0F, 0.0F, false);

		lenta3 = new ModelRenderer(this);
		lenta3.setPos(1.0F, -7.0F, 5.0F);
		Head.addChild(lenta3);
		setRotationAngle(lenta3, -0.6759F, -1.1104F, -0.7721F);
		lenta3.texOffs(0, 42).addBox(0.0F, -1.0F, 0.0F, 0.0F, 1.0F, 9.0F, 0.0F, false);

		lenta3_r1 = new ModelRenderer(this);
		lenta3_r1.setPos(0.0F, 0.0F, 9.0F);
		lenta3.addChild(lenta3_r1);
		setRotationAngle(lenta3_r1, 0.0F, 0.5672F, 0.0F);
		lenta3_r1.texOffs(3, 46).addBox(0.0F, -1.0F, 0.0F, 0.0F, 1.0F, 6.0F, 0.0F, false);
	}
