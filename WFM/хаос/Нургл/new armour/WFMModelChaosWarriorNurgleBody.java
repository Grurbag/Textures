...
public class WFMModelChaosWarriorNurgleBody extends EntityModel<Entity> {
	...
	public WFMModelChaosWarriorNurgleBody() {
		texWidth = 64;
		texHeight = 64;
		...
		maw.setPos(0.0F, 7.0F, -4.0F);
		Body.addChild(maw);
		maw.texOffs(44, 0).addBox(-4.0F, -2.0F, -0.3F, 8.0F, 8.0F, 2.0F, 0.0F, false);
