...
public class WFMModelHighElfBody extends EntityModel<Entity> {
	...
	public WFMModelHighElfBody() {
		...
		Body.texOffs(58, 0).addBox(-1.5F, 1.0F, -2.79F, 3.0F, 12.0F, 0.0F, 0.0F, false);
		...
		shoulder_right2.texOffs(36, 38).addBox(-2.75F, -2.5F, -3.5F, 8.0F, 6.0F, 6.0F, 0.1F, true);
		shoulder_right2.texOffs(36, 52).addBox(-2.75F, -2.5F, -3.5F, 8.0F, 6.0F, 6.0F, -0.15F, true);
