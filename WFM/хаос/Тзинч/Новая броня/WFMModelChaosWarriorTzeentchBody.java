...
public class WFMModelChaosWarriorTzeentchBody extends EntityModel<Entity> {
	...
	public WFMModelChaosWarriorTzeentchBody() {
		...
		shkura.texOffs(0, 14).addBox(-4.0F, -3.0F, -0.9F, 7.0F, 3.0F, 2.0F, 0.0F, false);

		shkura2 = new ModelRenderer(this);
		shkura2.setPos(4.0F, 2.0F, 4.0F);
		Body.addChild(shkura2);
		shkura2.texOffs(0, 14).addBox(-4.0F, -3.0F, -0.9F, 7.0F, 3.0F, 2.0F, 0.0F, true);
		...
		Naplechnik3_r1.setPos(12.0F, -0.5F, 0.0F);
		shoulderRight.addChild(Naplechnik3_r1);
		setRotationAngle(Naplechnik3_r1, 0.0F, 0.0F, -0.1309F);
		Naplechnik3_r1.texOffs(57, 0).addBox(-14.5F, -7.5F, 4.0F, 1.0F, 5.0F, 2.0F, 0.0F, true);
		Naplechnik3_r1.texOffs(46, 0).addBox(-14.5F, -9.5F, -4.0F, 1.0F, 4.0F, 8.0F, 0.0F, true);
		Naplechnik3_r1.texOffs(46, 0).addBox(-14.5F, -7.5F, -6.0F, 1.0F, 5.0F, 2.0F, 0.0F, true);
		...
		Naplechnik3_r2 = new ModelRenderer(this);
		Naplechnik3_r2.setPos(4.0F, -0.5F, 0.0F);
		shoulderLeft.addChild(Naplechnik3_r2);
		setRotationAngle(Naplechnik3_r2, 0.0F, 0.0F, 0.1309F);
		Naplechnik3_r2.texOffs(57, 0).addBox(-2.5F, -5.5F, 4.0F, 1.0F, 5.0F, 2.0F, 0.0F, false);
		Naplechnik3_r2.texOffs(46, 0).addBox(-2.5F, -5.5F, -6.0F, 1.0F, 5.0F, 2.0F, 0.0F, false);
		Naplechnik3_r2.texOffs(46, 0).addBox(-2.5F, -7.5F, -4.0F, 1.0F, 4.0F, 8.0F, 0.0F, false);
