...
public class WFMModelSlaaneshLegs extends EntityModel<Entity> {
	...
	public WFMModelSlaaneshLegs() {
		...
		nakolennik_r1.texOffs(1, 57).addBox(-0.9267F, -0.5F, -2.0F, 3.0F, 3.0F, 3.0F, 0.7F, true);

		RightLeg_r1 = new ModelRenderer(this);
		RightLeg_r1.setPos(-1.0F, -2.0F, 1.0F);
		...
		nakolennik_r2.texOffs(1, 57).addBox(-1.5F, -0.5F, -2.0F, 3.0F, 3.0F, 3.0F, 0.7F, false);

		RightLeg_r3 = new ModelRenderer(this);
		RightLeg_r3.setPos(0.0F, -1.0F, 1.0F);
		...
		RightLeg_r3.texOffs(0, 0).addBox(-2.0F, 1.0F, -3.0F, 5.0F, 12.0F, 4.0F, 0.7F, false);
	}
