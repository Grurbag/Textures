...
public class WFMModelSkavenHelmet extends EntityModel<Entity> {
	private final ModelRenderer head;
	private final ModelRenderer jaw_top;

	public WFMModelSkavenHelmet() {
		texWidth = 64;
		texHeight = 64;
		...
		head.texOffs(16, 45).addBox(-3.5F, -6.0F, -7.0F, 7.0F, 8.0F, 6.0F, 1.0F, false);
		head.texOffs(0, 20).addBox(0.0F, -10.0F, -13.0F, 0.0F, 5.0F, 13.0F, 0.0F, false);
