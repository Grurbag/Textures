...
public class WFMModelVampireBloodKnightChestplate extends EntityModel<Entity> {
	...
	public WFMModelVampireBloodKnightChestplate() {
		texWidth = 64;
		texHeight = 64;
		...
		bone2.setPos(5.5655F, 0.5478F, -3.0F);
		shoulder.addChild(bone2);
		setRotationAngle(bone2, -0.0494F, 0.5155F, -0.1991F);
		

		shoulder_r1 = new ModelRenderer(this);
		shoulder_r1.setPos(0.0F, 0.0F, 0.0F);
		bone2.addChild(shoulder_r1);
		setRotationAngle(shoulder_r1, 0.0F, -0.5236F, 0.1309F);
		shoulder_r1.texOffs(0, 58).addBox(-6.0F, -6.0F, 0.0F, 6.0F, 6.0F, 0.0F, 0.0F, true);

		bone3 = new ModelRenderer(this);
		bone3.setPos(5.5655F, 0.5478F, 3.0F);
		shoulder.addChild(bone3);
		setRotationAngle(bone3, -0.0494F, 0.5155F, -0.1991F);
		

		shoulder_r2 = new ModelRenderer(this);
		shoulder_r2.setPos(0.0F, 0.0F, 0.0F);
		bone3.addChild(shoulder_r2);
		setRotationAngle(shoulder_r2, 0.0F, -0.5236F, 0.1309F);
		shoulder_r2.texOffs(0, 58).addBox(-6.0F, -6.0F, 0.0F, 6.0F, 6.0F, 0.0F, 0.0F, true);
		...
		bone4.setPos(-5.4345F, 0.5478F, -3.0F);
		shoulder2.addChild(bone4);
		setRotationAngle(bone4, 3.0922F, -0.5155F, -2.9425F);
		

		shoulder_r3 = new ModelRenderer(this);
		shoulder_r3.setPos(0.0F, 0.0F, 0.0F);
		bone4.addChild(shoulder_r3);
		setRotationAngle(shoulder_r3, 0.0F, -0.5236F, 0.1309F);
		shoulder_r3.texOffs(0, 58).addBox(-6.0F, -6.0F, 0.0F, 6.0F, 6.0F, 0.0F, 0.0F, true);

		bone5 = new ModelRenderer(this);
		bone5.setPos(-5.4345F, 0.5478F, 3.0F);
		shoulder2.addChild(bone5);
		setRotationAngle(bone5, 3.0922F, -0.5155F, -2.9425F);
		

		shoulder_r4 = new ModelRenderer(this);
		shoulder_r4.setPos(0.0F, 0.0F, 0.0F);
		bone5.addChild(shoulder_r4);
		setRotationAngle(shoulder_r4, 0.0F, -0.5236F, 0.1309F);
		shoulder_r4.texOffs(0, 58).addBox(-6.0F, -6.0F, 0.0F, 6.0F, 6.0F, 0.0F, 0.0F, true);
