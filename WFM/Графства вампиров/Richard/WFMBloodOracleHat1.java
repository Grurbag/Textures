...
public class custom_model extends ModelBase {
	...
	public custom_model() {
		...
		vorotnik.setRotationPoint(-1.0F, 0.0F, 1.0F);
		helmet.addChild(vorotnik);
		...
		vorotnik3.setRotationPoint(0.0F, 0.0F, 0.0F);
		vorotnik2.addChild(vorotnik3);
		vorotnik3.cubeList.add(new ModelBox(vorotnik3, 48, 19, 6.0F, -5.0F, -4.0F, 0, 5, 8, 0.0F, false));

		hat = new ModelRenderer(this);
		hat.setRotationPoint(0.0F, -6.5F, -2.0F);
		helmet.addChild(hat);
		setRotationAngle(hat, -0.4848F, -0.6888F, 0.3298F);
		hat.cubeList.add(new ModelBox(hat, 0, 0, -6.0F, -0.5F, -6.0F, 12, 1, 12, 0.0F, false));

		hat2 = new ModelRenderer(this);
		hat2.setRotationPoint(0.0F, 24.0F, 0.0F);
		helmet.addChild(hat2);
