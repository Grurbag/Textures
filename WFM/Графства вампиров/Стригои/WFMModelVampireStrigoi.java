...
public class custom_model extends ModelBase {
	...
	private final ModelRenderer finger_left1;
	private final ModelRenderer finger_left2;
	private final ModelRenderer finger_left3;
	...
	public custom_model() {
		...
		body.setRotationPoint(0.0F, 0.0F, -6.0F);
		setRotationAngle(body, 0.2618F, 0.0F, 0.0F);
		body.cubeList.add(new ModelBox(body, 16, 16, -4.0F, -3.0F, 3.0F, 8, 14, 4, 0.0F, false));
		...
		leg_left.cubeList.add(new ModelBox(leg_left, 0, 16, -2.4F, -2.0928F, -2.3199F, 4, 10, 4, 0.0F, false));

		leg_left2 = new ModelRenderer(this);
		leg_left2.setRotationPoint(2.0F, 13.1367F, -10.5628F);
		leg_left.addChild(leg_left2);
		setRotationAngle(leg_left2, 1.8326F, 0.0F, 0.0F);
		leg_left2.cubeList.add(new ModelBox(leg_left2, 0, 30, -4.5F, 12.37F, 2.5961F, 4, 7, 3, 0.0F, false));

		leg_left3 = new ModelRenderer(this);
		leg_left3.setRotationPoint(1.0F, 19.0F, -8.0F);
		leg_left2.addChild(leg_left3);
		setRotationAngle(leg_left3, 1.7453F, 0.0F, 0.0F);
		leg_left3.cubeList.add(new ModelBox(leg_left3, 0, 40, -5.0F, 5.1296F, -2.3144F, 3, 7, 3, 0.0F, false));

		finger_left1 = new ModelRenderer(this);
		finger_left1.setRotationPoint(0.0F, -1.0F, 4.0F);
		leg_left3.addChild(finger_left1);
		setRotationAngle(finger_left1, 0.1745F, 0.0F, 0.0F);
		finger_left1.cubeList.add(new ModelBox(finger_left1, 0, 50, -4.0F, 5.0F, -5.0F, 1, 1, 4, 0.0F, false));

		finger_left2 = new ModelRenderer(this);
		finger_left2.setRotationPoint(0.0F, -1.0F, 4.0F);
		leg_left3.addChild(finger_left2);
		setRotationAngle(finger_left2, 0.1694F, -0.2129F, 0.0479F);
		finger_left2.cubeList.add(new ModelBox(finger_left2, 0, 50, -6.0822F, 5.3633F, -4.8815F, 1, 1, 4, 0.0F, false));

		finger_left3 = new ModelRenderer(this);
		finger_left3.setRotationPoint(0.0F, -1.0F, 3.0F);
		leg_left3.addChild(finger_left3);
		setRotationAngle(finger_left3, 0.1235F, 0.2555F, -0.0579F);
		finger_left3.cubeList.add(new ModelBox(finger_left3, 0, 55, -2.7059F, 5.0F, -4.8296F, 1, 1, 5, 0.0F, false));

		leg_right = new ModelRenderer(this);
		leg_right.setRotationPoint(-2.0F, 10.0F, 1.0F);
		setRotationAngle(leg_right, -0.6109F, 0.0F, 0.0F);
		leg_right.cubeList.add(new ModelBox(leg_right, 0, 16, -2.4F, -2.0928F, -2.3199F, 4, 10, 4, 0.0F, false));

		leg_right2 = new ModelRenderer(this);
		leg_right2.setRotationPoint(2.0F, 13.1367F, -10.5628F);
		leg_right.addChild(leg_right2);
		setRotationAngle(leg_right2, 1.8326F, 0.0F, 0.0F);
		leg_right2.cubeList.add(new ModelBox(leg_right2, 0, 30, -4.5F, 12.37F, 2.5961F, 4, 7, 3, 0.0F, false));

		leg_right3 = new ModelRenderer(this);
		leg_right3.setRotationPoint(1.0F, 19.0F, -8.0F);
		leg_right2.addChild(leg_right3);
		setRotationAngle(leg_right3, 1.7453F, 0.0F, 0.0F);
		leg_right3.cubeList.add(new ModelBox(leg_right3, 0, 40, -5.0F, 5.1296F, -2.3144F, 3, 7, 3, 0.0F, false));

		finger_right_1 = new ModelRenderer(this);
		finger_right_1.setRotationPoint(0.0F, -1.0F, 4.0F);
		leg_right3.addChild(finger_right_1);
		setRotationAngle(finger_right_1, 0.1745F, 0.0F, 0.0F);
		...
		finger_right_2.setRotationPoint(0.0F, -1.0F, 4.0F);
		leg_right3.addChild(finger_right_2);
		setRotationAngle(finger_right_2, 0.1694F, -0.2129F, 0.0479F);
		finger_right_2.cubeList.add(new ModelBox(finger_right_2, 0, 50, -6.0822F, 5.3633F, -4.8815F, 1, 1, 4, 0.0F, false));

		finger_right_3 = new ModelRenderer(this);
		finger_right_3.setRotationPoint(0.0F, -1.0F, 3.0F);
		leg_right3.addChild(finger_right_3);
		setRotationAngle(finger_right_3, 0.1235F, 0.2555F, -0.0579F);
