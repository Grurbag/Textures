...
public class WFMModelCathayCelestialGuardChestplate extends EntityModel<Entity> {
	...
	public WFMModelCathayCelestialGuardChestplate() {
		texWidth = 64;
		texHeight = 64;
		...
		LeftArm_r2.texOffs(40, 32).addBox(-3.0F, -2.5F, -3.0F, 6.0F, 5.0F, 6.0F, 0.1F, true);
