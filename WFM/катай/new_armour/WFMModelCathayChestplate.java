...
public class WFMModelCathayChestplate extends EntityModel<Entity> {
	...
	public WFMModelCathayChestplate() {
		texWidth = 64;
		texHeight = 64;
		...
		shoulderRight.setPos(-2.2479F, -0.4674F, 0.0F);
		RightArm.addChild(shoulderRight);
		

		LeftArm_r1 = new ModelRenderer(this);
		LeftArm_r1.setPos(1.1417F, 1.2773F, 0.0F);
		...
		LeftArm_r2.texOffs(40, 32).addBox(-2.0F, -2.5F, -3.0F, 6.0F, 5.0F, 6.0F, 0.1F, true);
		LeftArm_r2.texOffs(40, 43).addBox(-3.0F, -2.5F, -3.0F, 6.0F, 5.0F, 6.0F, 0.3F, true);
		...
		RightArm_r1.setPos(-0.8939F, 1.31F, 0.0F);
		...
		RightArm_r2.texOffs(40, 32).addBox(-3.75F, -2.5F, -3.0F, 6.0F, 5.0F, 6.0F, 0.1F, false);
	}
