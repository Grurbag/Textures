...
public class custom_model extends ModelBase {
	...
	public custom_model() {
		...
		dragon.setRotationPoint(0.0F, -12.0F, -2.5F);
		helmet.addChild(dragon);
		setRotationAngle(dragon, -1.5708F, -1.309F, 1.5708F);
		dragon.cubeList.add(new ModelBox(dragon, 42, 12, 0.0F, -7.0F, -4.0F, 0, 10, 8, 0.0F, false));
		...
		wing_left.setRotationPoint(5.5188F, -10.0F, 0.5367F);
		helmet.addChild(wing_left);
		setRotationAngle(wing_left, 0.0F, 0.5236F, 0.0F);
		wing_left.cubeList.add(new ModelBox(wing_left, 40, -12, 0.0F, -10.0F, -6.0F, 0, 20, 12, 0.0F, true));
		...
		wing_right.setRotationPoint(-5.5529F, -10.0F, 0.7956F);
		helmet.addChild(wing_right);
		setRotationAngle(wing_right, 0.0F, -0.5236F, 0.0F);
		wing_right.cubeList.add(new ModelBox(wing_right, 40, -12, 0.0F, -10.0F, -6.2556F, 0, 20, 12, 0.0F, false));
