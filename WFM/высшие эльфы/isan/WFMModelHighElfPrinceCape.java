...
public class WFMModelHighElfPrinceCape extends ModelBase {
	private final ModelRenderer bipedBody;
	private final ModelRenderer cape;
	private final ModelRenderer hand_left;
	private final ModelRenderer hand_right;

	public WFMModelHighElfPrinceCape() {
		textureWidth = 64;
		textureHeight = 32;
		...
		hand_right.cubeList.add(new ModelBox(hand_right, 16, 16, -3.0F, -2.0F, -2.0F, 4, 12, 4, 0.5F, false));
	}
