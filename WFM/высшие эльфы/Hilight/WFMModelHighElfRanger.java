...
public class WFMModelHighElfRanger extends ModelBase {
	...
	public WFMModelHighElfRanger() {
		...
		bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 40, 48, -1.0F, -2.0F, -2.0F, 4, 12, 4, 0.6F, true));
