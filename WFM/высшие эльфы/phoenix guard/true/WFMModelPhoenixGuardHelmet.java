...
public class custom_model extends ModelBase {
	...
	public custom_model() {
		...
		dragon.setRotationPoint(-2.5F, -12.0F, -2.5F);
		helmet.addChild(dragon);
		dragon.cubeList.add(new ModelBox(dragon, 42, 12, 2.5F, -7.0F, -4.0F, 0, 10, 8, 0.0F, false));
		...
		wing_left.setRotationPoint(3.0F, -16.0F, -3.0F);
		helmet.addChild(wing_left);
		setRotationAngle(wing_left, 0.0F, 0.2618F, 0.0F);
		

		wing_left_r1 = new ModelRenderer(this);
		wing_left_r1.setRotationPoint(-3.0F, 40.0F, 3.0F);
		wing_left.addChild(wing_left_r1);
		setRotationAngle(wing_left_r1, 0.0F, 0.9599F, 0.0F);
		wing_left_r1.cubeList.add(new ModelBox(wing_left_r1, 40, -12, 2.0F, -44.0F, 1.0F, 0, 20, 12, 0.0F, true));
		...
		wing_right.setRotationPoint(-4.0F, -16.0F, -3.0F);
		helmet.addChild(wing_right);
		setRotationAngle(wing_right, 0.0F, -0.2618F, 0.0F);
		

		wing_right_r1 = new ModelRenderer(this);
		wing_right_r1.setRotationPoint(4.0F, 40.0F, 3.0F);
		wing_right.addChild(wing_right_r1);
		setRotationAngle(wing_right_r1, 0.0F, -0.9599F, 0.0F);
		wing_right_r1.cubeList.add(new ModelBox(wing_right_r1, 40, -12, -3.0F, -44.0F, 1.0F, 0, 20, 12, 0.0F, false));
