...
public class WFMModModelSeaGuardHelmet extends ModelBase {
	...
	public WFMModModelSeaGuardHelmet() {
		textureWidth = 64;
		textureHeight = 32;
		...
		fish.setRotationPoint(0.0F, -12.0F, 0.0F);
		helmet.addChild(fish);
		setRotationAngle(fish, 0.0F, -0.7854F, 0.0F);
		fish.cubeList.add(new ModelBox(fish, 48, 19, -3.0F, -4.5F, -3.0F, 4, 5, 4, 0.0F, false));

		fish2 = new ModelRenderer(this);
		fish2.setRotationPoint(2.8284F, 0.0F, 2.8284F);
		fish.addChild(fish2);
		setRotationAngle(fish2, 0.0F, -0.7854F, 0.0F);
		fish2.cubeList.add(new ModelBox(fish2, 46, 0, -3.0F, -7.0F, 0.0F, 9, 18, 0, 0.0F, false));
	}
