...
public class WFMModelHarganethExecutionerBody extends EntityModel<Entity> {
	...
	public WFMModelHarganethExecutionerBody() {
		texWidth = 64;
		texHeight = 64;
		...
		LeftArm.texOffs(54, 33).addBox(3.0F, 1.0F, 0.0F, 5.0F, 9.0F, 0.0F, 0.0F, true);
		...
		RightArm.texOffs(54, 33).addBox(-8.0F, 1.0F, 0.0F, 5.0F, 9.0F, 0.0F, 0.0F, false);
