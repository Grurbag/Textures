...
public class WFMModelBretonniaKnightLeggings extends EntityModel<Entity> {
	private final ModelRenderer LeftLeg;
	private final ModelRenderer RightLeg_r1;
	private final ModelRenderer RightLeg;
	private final ModelRenderer RightLeg_r2;

	public WFMModelBretonniaKnightLeggings() {
		texWidth = 64;
		texHeight = 64;
		...
		RightLeg_r2.texOffs(0, 35).addBox(-2.0F, 1.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.7F, true);
	}
