...
public class WFMModelBrunnerBoots extends EntityModel<Entity> {
	...
	public WFMModelBrunnerBoots() {
		...
		rightLeg.texOffs(16, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.25F, false);

		nakolennik_r1 = new ModelRenderer(this);
		nakolennik_r1.setPos(-0.2F, 6.7071F, -2.0F);
		rightLeg.addChild(nakolennik_r1);
		setRotationAngle(nakolennik_r1, 0.2519F, -0.2443F, 0.7543F);
		nakolennik_r1.texOffs(0, 0).addBox(-1.5F, -1.5F, -1.0F, 3.0F, 3.0F, 2.0F, 0.0F, false);
		...
		leftLeg.texOffs(16, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.25F, true);

		nakolennik_r2 = new ModelRenderer(this);
		nakolennik_r2.setPos(0.0F, 6.7071F, -2.0F);
		leftLeg.addChild(nakolennik_r2);
		setRotationAngle(nakolennik_r2, 0.2519F, -0.2443F, 0.7543F);
		nakolennik_r2.texOffs(0, 0).addBox(-1.5F, -1.5F, -1.0F, 3.0F, 3.0F, 2.0F, 0.0F, false);
