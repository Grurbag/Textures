...
public class WFMModelDwarfHammererLegs extends EntityModel<Entity> {
	...
	public WFMModelDwarfHammererLegs() {
		texWidth = 64;
		texHeight = 64;
		...
		RightLeg_r1.texOffs(32, 0).addBox(3.0F, 1.0F, -2.0F, 4.0F, 11.0F, 4.0F, 0.9F, true);

		LeftLeg_r1 = new ModelRenderer(this);
		LeftLeg_r1.setPos(0.0F, -1.0F, 0.0F);
		leftLeg.addChild(LeftLeg_r1);
		setRotationAngle(LeftLeg_r1, 0.0F, 0.0F, -0.0436F);
		LeftLeg_r1.texOffs(16, 0).addBox(-1.0F, 1.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.7F, true);
		...
		RightLeg_r2.texOffs(32, 0).addBox(-3.0F, 1.0F, -2.0F, 4.0F, 11.0F, 4.0F, 0.9F, false);
		...
		RightLeg_r3.texOffs(16, 0).addBox(-3.0F, 1.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.7F, false);

		scales = new ModelRenderer(this);
		scales.setPos(0.0F, 0.0F, 0.0F);
		rightLeg.addChild(scales);
