...
public class WFMModelChaosDwarfBoots extends EntityModel<Entity> {
	...
	public WFMModelChaosDwarfBoots() {
		texWidth = 64;
		texHeight = 64;

		LeftBoot = new ModelRenderer(this);
		LeftBoot.setPos(1.9F, 12.0F, 0.0F);
		LeftBoot.texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.9F, true);

		nose_r1 = new ModelRenderer(this);
		nose_r1.setPos(0.0F, 13.0F, -4.0F);
		LeftBoot.addChild(nose_r1);
		setRotationAngle(nose_r1, 0.0873F, 0.0F, 0.0F);
		nose_r1.texOffs(0, 0).addBox(-0.4F, -4.0F, -0.5F, 1.0F, 4.0F, 1.0F, 0.0F, false);

		RightLeg_r1 = new ModelRenderer(this);
		RightLeg_r1.setPos(0.0F, 11.5F, -3.0F);
		LeftBoot.addChild(RightLeg_r1);
		setRotationAngle(RightLeg_r1, 0.0873F, 0.0F, 0.0F);
		RightLeg_r1.texOffs(0, 32).addBox(-2.5F, -1.0F, -0.35F, 5.0F, 2.0F, 1.0F, 0.4F, true);

		RightBoot = new ModelRenderer(this);
		RightBoot.setPos(-1.9F, 12.0F, 0.0F);
		RightBoot.texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.9F, false);

		nose_r2 = new ModelRenderer(this);
		nose_r2.setPos(-0.2F, 13.0F, -4.0F);
		RightBoot.addChild(nose_r2);
		setRotationAngle(nose_r2, 0.0873F, 0.0F, 0.0F);
		nose_r2.texOffs(0, 0).addBox(-0.4F, -4.0F, -0.5F, 1.0F, 4.0F, 1.0F, 0.0F, false);

		RightLeg_r2 = new ModelRenderer(this);
		RightLeg_r2.setPos(0.0F, 11.5F, -3.0F);
		RightBoot.addChild(RightLeg_r2);
		setRotationAngle(RightLeg_r2, 0.0873F, 0.0F, 0.0F);
		RightLeg_r2.texOffs(0, 32).addBox(-2.5F, -1.0F, -0.35F, 5.0F, 2.0F, 1.0F, 0.4F, false);
	}
