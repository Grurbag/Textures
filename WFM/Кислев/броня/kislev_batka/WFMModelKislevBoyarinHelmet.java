...
public class custom_model extends ModelBase {
	...
	public custom_model() {
		...
		feather.setRotationPoint(1.0F, -5.0F, -4.0F);
		helmet.addChild(feather);
		setRotationAngle(feather, 0.0F, 0.0F, -0.7854F);
		feather.cubeList.add(new ModelBox(feather, 0, 22, -1.0F, -10.5F, -1.0F, 10, 10, 0, 0.0F, false));
