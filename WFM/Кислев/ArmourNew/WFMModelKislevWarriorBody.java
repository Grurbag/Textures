...
public class WFMModelKislevWarriorBody extends ModelBase {
	...
	public WFMModelKislevWarriorBody() {
		textureWidth = 64;
		textureHeight = 64;
		...
		RightArm.cubeList.add(new ModelBox(RightArm, 40, 16, -3.0F, -2.0F, -2.0F, 4, 12, 4, 0.49F, true));
		RightArm.cubeList.add(new ModelBox(RightArm, 0, 0, -3.0F, -2.0F, -2.0F, 4, 12, 4, 0.69F, true));
		...
		LeftArm_r1.cubeList.add(new ModelBox(LeftArm_r1, 40, 32, -3.0F, -2.5F, -3.0F, 6, 5, 6, 0.1F, true));
		LeftArm_r1.cubeList.add(new ModelBox(LeftArm_r1, 40, 43, -3.0F, -2.5F, -3.0F, 6, 5, 6, 0.3F, true));
		...
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 40, 32, -2.75F, -2.5F, -3.0F, 6, 5, 6, 0.1F, false));
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 40, 43, -2.75F, -2.5F, -3.0F, 6, 5, 6, 0.3F, false));
