...
public class Штаны Гвардейца extends ModelBase {
	private final ModelRenderer LeftLeg;
	private final ModelRenderer LeftLeg_r1;
	private final ModelRenderer RightLeg;
	private final ModelRenderer RightLeg_r1;

	public Штаны Гвардейца() {
		textureWidth = 64;
		textureHeight = 64;
		...
		LeftLeg_r1.cubeList.add(new ModelBox(LeftLeg_r1, 0, 0, -2.0F, 1.0F, -2.0F, 4, 12, 4, 0.7F, false));
		...
		RightLeg_r1.cubeList.add(new ModelBox(RightLeg_r1, 16, 0, -2.0F, 1.0F, -2.0F, 4, 12, 4, 0.7F, false));
	}
