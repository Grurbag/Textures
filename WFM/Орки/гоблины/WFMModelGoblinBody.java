...
public class WFMModelGoblinBody extends EntityModel<Entity> {
	...
	public WFMModelGoblinBody() {
		texWidth = 64;
		texHeight = 64;

		bodyArmour = new ModelRenderer(this);
		bodyArmour.setPos(0.0F, 10.0F, 1.0F);
		bodyArmour.texOffs(15, 25).addBox(-4.0F, -5.0F, -2.0F, 8.0F, 10.0F, 4.0F, 0.49F, false);

		bodyArmour2 = new ModelRenderer(this);
		bodyArmour2.setPos(0.0F, -10.0F, -1.0F);
		bodyArmour.addChild(bodyArmour2);
		bodyArmour2.texOffs(14, 15).addBox(-4.0F, 3.0F, -3.0F, 8.0F, 5.0F, 5.0F, 0.49F, false);

		bodyArmour3 = new ModelRenderer(this);
		bodyArmour3.setPos(0.0F, -10.0F, -1.0F);
		bodyArmour.addChild(bodyArmour3);
		bodyArmour3.texOffs(15, 50).addBox(-4.0F, 5.0F, -1.0F, 8.0F, 10.0F, 4.0F, 0.3F, false);

		bodyArmour4 = new ModelRenderer(this);
		bodyArmour4.setPos(0.0F, 0.0F, 0.0F);
		bodyArmour3.addChild(bodyArmour4);
		bodyArmour4.texOffs(14, 40).addBox(-4.0F, 3.0F, -3.0F, 8.0F, 5.0F, 5.0F, 0.3F, false);

		leftHandArmour = new ModelRenderer(this);
		leftHandArmour.setPos(5.0F, 6.0F, -1.0F);
		leftHandArmour.texOffs(40, 16).addBox(-1.0F, -1.0F, -2.0F, 3.0F, 11.0F, 4.0F, 0.5F, true);

		leftHandArmour2 = new ModelRenderer(this);
		leftHandArmour2.setPos(0.0F, -3.0F, 0.0F);
		leftHandArmour.addChild(leftHandArmour2);
		leftHandArmour2.texOffs(40, 31).addBox(-1.0F, 2.0F, -2.0F, 3.0F, 11.0F, 4.0F, 0.3F, true);
		...
		rightHandArmour.texOffs(40, 16).addBox(-2.0F, -1.0F, -2.0F, 3.0F, 11.0F, 4.0F, 0.5F, false);

		rightHandArmour2 = new ModelRenderer(this);
		rightHandArmour2.setPos(0.0F, -3.0F, 0.0F);
		rightHandArmour.addChild(rightHandArmour2);
		rightHandArmour2.texOffs(40, 31).addBox(-2.0F, 2.0F, -2.0F, 3.0F, 11.0F, 4.0F, 0.3F, false);
