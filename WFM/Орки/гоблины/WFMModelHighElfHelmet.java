...
public class WFMModelHighElfHelmet extends EntityModel<Entity> {
	private final ModelRenderer Head;

	public WFMModelHighElfHelmet() {
		texWidth = 64;
		texHeight = 64;
		...
		Head.texOffs(0, 40).addBox(-8.5F, -18.0F, -5.2F, 17.0F, 24.0F, 0.0F, 0.0F, false);
	}
