...
public class WFMModelBeastmanGorBoots extends ModelBase {
	...
	public WFMModelBeastmanGorBoots() {
		textureWidth = 64;
		textureHeight = 64;
		...
		rightLegArmour.addChild(RightLeg_r1);
		setRotationAngle(RightLeg_r1, -0.1745F, 0.0F, 0.0F);
		RightLeg_r1.cubeList.add(new ModelBox(RightLeg_r1, 48, 17, -4.1F, -1.0F, -2.0F, 4, 8, 4, 0.5F, true));
		...
		rightLegArmour2.addChild(RightLeg_r2);
		setRotationAngle(RightLeg_r2, 0.48F, 0.0F, 0.0F);
		RightLeg_r2.cubeList.add(new ModelBox(RightLeg_r2, 50, 29, -2.5F, -1.0F, -2.0F, 3, 6, 4, 0.5F, true));
		...
		leftLegArmour.addChild(RightLeg_r3);
		setRotationAngle(RightLeg_r3, -0.1745F, 0.0F, 0.0F);
		RightLeg_r3.cubeList.add(new ModelBox(RightLeg_r3, 48, 17, -0.1F, -1.0F, -2.0F, 4, 8, 4, 0.5F, false));
		...
		leftLegArmour2.addChild(RightLeg_r4);
		setRotationAngle(RightLeg_r4, 0.48F, 0.0F, 0.0F);
		RightLeg_r4.cubeList.add(new ModelBox(RightLeg_r4, 50, 29, -2.5F, -1.0F, -2.0F, 3, 6, 4, 0.5F, false));
