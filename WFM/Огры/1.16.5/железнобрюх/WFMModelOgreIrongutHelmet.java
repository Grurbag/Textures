...
public class WFMModelOgreIrongutHelmet extends EntityModel<Entity> {
	private final ModelRenderer head;
	private final ModelRenderer horn;
	private final ModelRenderer horn_r1;
	private final ModelRenderer horn_r2;

	public WFMModelOgreIrongutHelmet() {
		texWidth = 128;
		texHeight = 128;
		...
		horn.setPos(0.0F, -7.0F, -16.0F);
		head.addChild(horn);
		horn.texOffs(0, -14).addBox(0.5F, -11.0F, -1.0F, 0.0F, 15.0F, 14.0F, 0.0F, false);
		...
		horn_r1.texOffs(0, -14).addBox(0.5F, -11.0F, -1.0F, 0.0F, 15.0F, 14.0F, 0.0F, false);
		...
		horn_r2.texOffs(0, -14).addBox(0.5F, -11.0F, -1.0F, 0.0F, 15.0F, 14.0F, 0.0F, false);
	}
