...
public class LOTRModelHaradMumakil extends ModelBase {
	...
	public LOTRModelHaradMumakil() {
		textureWidth = 256;
		textureHeight = 256;

		Head = new ModelRenderer(this);
		Head.setRotationPoint(0.0F, -10.0F, -19.5F);
		setRotationAngle(Head, -0.1745F, 0.0F, 0.0F);
		Head.cubeList.add(new ModelBox(Head, 0, 0, -5.5F, -7.9696F, -8.3473F, 11, 12, 10, 0.0F, false));

		jaw_lower = new ModelRenderer(this);
		jaw_lower.setRotationPoint(0.0F, 2.5F, 3.0F);
		...
		jaw_upper.setRotationPoint(0.0F, 6.5F, -5.0F);
		...
		ear_left.setRotationPoint(-1.0F, -1.0F, 3.0F);
		...
		ear_right.setRotationPoint(1.0F, -1.0F, 3.0F);
		...
		Neck.setRotationPoint(0.0F, 0.0F, 6.5F);
		Head.addChild(Neck);
		...
		leg_right_front.cubeList.add(new ModelBox(leg_right_front, 52, 62, -3.5F, -2.0F, -3.5F, 8, 16, 8, 0.0F, false));
		...
		leg_left_front.cubeList.add(new ModelBox(leg_left_front, 52, 62, -3.3F, -2.0F, -3.5F, 8, 16, 8, 0.0F, false));
		...
		leg_right_back.setRotationPoint(-6.6F, -2.0F, -6.6F);
		leg_right_back.cubeList.add(new ModelBox(leg_right_back, 52, 62, -3.5F, -2.0F, 22.5F, 8, 16, 8, 0.0F, false));

		leg_right_back2 = new ModelRenderer(this);
		leg_right_back2.setRotationPoint(0.0F, 16.0F, 0.0F);
