...
public class MorwathBerserkerLegs extends ModelBase {
	...
	public MorwathBerserkerLegs() {
		...
		shoulder.setRotationPoint(4.1F, 1.5F, 0.0F);
		LeftLeg.addChild(shoulder);
		setRotationAngle(shoulder, 0.0F, 0.0F, 1.3526F);
		...
		shoulder.addChild(shoulder4_r1);
		...
		RightLeg.cubeList.add(new ModelBox(RightLeg, 16, 16, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.25F, false));
		...
		RightLeg_r2.cubeList.add(new ModelBox(RightLeg_r2, 16, 0, -2.0F, 1.0F, -2.0F, 4, 12, 4, 0.7F, true));

		shoulder2 = new ModelRenderer(this);
		shoulder2.setRotationPoint(-4.1F, 1.5F, 0.0F);
		RightLeg.addChild(shoulder2);
		setRotationAngle(shoulder2, -3.1416F, 0.0F, 1.789F);
		...
		shoulder2.addChild(shoulder4_r2);
